...
export function PostSkeleton() {
  return (
    <div className="animate-pulse space-y-4">
      ...
      <div className="rounded-xl border border-primary-500/10 bg-card p-6">
        <div className="mb-4 h-6 w-32 rounded bg-primary-500/10" />

        {/* Comment form skeleton */}
        <div className="mb-6 rounded-lg border border-primary-500/10 p-4">
          <div className="mb-3 h-20 w-full rounded bg-primary-500/10" />
          <div className="h-9 w-24 rounded bg-primary-500/10" />
        </div>
        ...
        <div className="space-y-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex gap-3">
              ...
              <div className="flex-1 space-y-2">
                <div className="h-4 w-32 rounded bg-primary-500/10" />
                <div className="h-3 w-full rounded bg-primary-500/10" />
              </div>
            </div>
          ))}
        </div>
